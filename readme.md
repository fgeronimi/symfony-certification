...
- [Routing](/topics/routing.md)
    - [Configuration (YAML, XML, PHP & attributes/annotations)](/topics/routing.md#configuration-yaml-xml-php--attributesannotations)
    - [Parameters](/topics/routing.md#parameters)
    - [Generate URL parameters](/topics/routing.md#generate-url-parameters)
    - [Trigger redirects](/topics/routing.md#trigger-redirects)
    - [Stateless Routes](/topics/routing.md#stateless-routes)
    - [Sub Domain Routing](/topics/routing.md#sub-domain-routing)
...
- [Security](/topics/security.md)
    ...
    - [Passwords encoders -> Password hashers](/topics/security.md#passwords-encoders)
    - [Roles](/topics/security.md#roles)
    - [Access Control Rules](/topics/security.md#access-control-rules)
    - [Guard authenticators -> Authenticators](/topics/security.md#guard-authenticators)
